...
namespace NettePropel2\Diagnostics;
...
class PropelPanel extends AbstractHandler implements Tracy\IBarPanel, HandlerInterface {
    ...
    public function logQuery($message) {
        ...
        list($time, $memory, $rows, $query) = explode('|', $message);
    ...
    public function getPanel() {
        ...
        return $this->count ?
                ...
                . '<table>'
                . '<tr><th>Time&nbsp;ms</th><th>SQL Query</th><th>Affected Rows</th><th>Memory</th></tr>' . $s
                . '</table>'
